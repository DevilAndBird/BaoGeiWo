...
static float const kPopoverViewArrowHeight = 8.f; ///< 箭头高度
...
//        self.backgroundColor = [UIColor colorWithRed:0.29 green:0.29 blue:0.29 alpha:1.00];
        self.backgroundColor = RGB(54, 55, 63);
...
//    float arrowBottomCornerRadius = 4.f;
    ...
    float arrowCornerRadius = 1.5f;
    float arrowBottomCornerRadius = 1.f;
...
//        toPoint.y = CGRectGetMaxY(pointViewRect) + 5;
        toPoint.y = CGRectGetMaxY(pointViewRect) + 3;
