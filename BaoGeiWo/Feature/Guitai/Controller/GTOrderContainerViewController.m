//
//  GTOrderContainerViewController.m
//  BaoGeiWo
//
...
@interface GTOrderContainerViewController ()
...
@implementation GTOrderContainerViewController
...
- (void)setupUI {
    self.segments = @[@"待支付", @"待收取", @"待释放", @"寄存件", @"已释放"];
...
//        [self.viewControllers addObject:[[GTOrderListViewController alloc] initWithType:i]];
//    }
    [self.viewControllers addObject:[[GTOrderListViewController alloc] initWithType:BGWGTOrderTypeWaitPay]];
    [self.viewControllers addObject:[[GTOrderListViewController alloc] initWithType:BGWGTOrderTypeTake]];
    [self.viewControllers addObject:[[GTOrderListViewController alloc] initWithType:BGWGTOrderTypeSend]];
    [self.viewControllers addObject:[[GTOrderListViewController alloc] initWithType:BGWGTOrderTypeDeposit]];
    [self.viewControllers addObject:[[GTOrderListViewController alloc] initWithType:BGWGTOrderTypeFinish]];
